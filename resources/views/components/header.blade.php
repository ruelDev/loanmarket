<div class="sticky top-0 md:relative z-50 bg-white w-full shadow-md">
    <div class="container">
        <div class="flex justify-between items-center">
            ...
            <ul class="items-center justify-between gap-5 hidden md:flex text-[1.1rem]">
                <li><a class="navbar-link" href="{{route('home')}}">Home</a></li>
                <li class="{{ request()->routeIs('home') ? '' : 'hidden' }}"><a class="navbar-link" href="#rso-section">Our Partners</a></li>
